<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.vb" Inherits="EvoHtmlToPdfWebDemo.Default" Title="Getting Started with EVO HTML to PDF Converter for .NET" %>
                ...
                <table cellpadding="0" cellspacing="0" border="1">
                    <tr>
                        <td class="demolinks_box" style="vertical-align: top; width: 280px">
                            <uc1:DemoLinksBox ID="ctrlDemoLinksBox" runat="server"></uc1:DemoLinksBox>
                        </td>
...
&lt;/html&gt;
    ...
    <span class="kwrd">Private</span> <span class="kwrd">Sub</span> ConvertURLToPDF()
        <span class="kwrd">Dim</span> urlToConvert <span class="kwrd">As</span> <span class="kwrd">String</span> = textBoxWebPageURL.Text.Trim()

            <span class="rem">' Create the PDF converter. Optionally the HTML viewer width can be
                specified as parameter</span>
        <span class="rem">' The default HTML viewer width is 1024 pixels.</span>
        <span class="kwrd">Dim</span> pdfConverter <span class="kwrd">As</span> <span class="kwrd">New</span> PdfConverter()
        ...
        <span class="rem">' set if the HTML content is resized if necessary to fit the PDF page
            width - default is true</span>
        ...
        <span class="rem">' enable auto-generated bookmarks for a specified list of HTML selectors
            (e.g. H1 and H2)</span>
        <span class="kwrd">If</span> cbBookmarks.Checked <span class="kwrd">Then</span>
        ...
        <span class="kwrd">If</span> cbAddHeader.Checked <span class="kwrd">Then</span>
            AddHeader(pdfConverter)
        <span class="kwrd">End</span> <span class="kwrd">If</span>
        <span class="rem">' add HTML footer</span>
        <span class="kwrd">If</span> cbAddFooter.Checked <span class="kwrd">Then</span>
        ...
        <span class="kwrd">Dim</span> pdfBytes() <span class="kwrd">As</span> <span class="kwrd">Byte</span> = pdfConverter.GetPdfBytesFromUrl(urlToConvert)

        <span class="rem">' send the PDF document as a response to the browser for download</span>
        <span class="kwrd">Dim</span> response <span class="kwrd">As</span> HttpResponse = HttpContext.Current.Response
        response.Clear()
        response.AddHeader(<span class="str">"Content-Type"</span>, <span class="str">"application/pdf"</span>)
        <span class="kwrd">If</span> radioAttachment.Checked <span class="kwrd">Then</span>
            response.AddHeader(<span class="str">"Content-Disposition"</span>, <span class="kwrd">String</span>.Format(<span
