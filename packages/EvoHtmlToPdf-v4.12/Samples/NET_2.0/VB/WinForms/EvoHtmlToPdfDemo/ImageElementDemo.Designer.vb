Namespace EvoHtmlToPdfDemo
	Partial Public Class ImageElementDemo
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(ImageElementDemo))
			Me.label1 = New Label()
			...
			Me.label1.Size = New Size(403, 31)
			Me.label1.TabIndex = 0
			Me.label1.Text = "This page will demonstrate how to add image elements to a PDF document. The image" & "s can be resized and displayed in any position in a PDF page."
			' 
			' btnCreatePdf
			' 
			Me.btnCreatePdf.FlatStyle = FlatStyle.Flat
			Me.btnCreatePdf.Location = New Point(12, 59)
			Me.btnCreatePdf.Name = "btnCreatePdf"
			Me.btnCreatePdf.Size = New Size(75, 27)
...
'			Me.btnCreatePdf.Click += New System.EventHandler(Me.btnCreatePdf_Click)
			...
			Me.btnCancel.Location = New Point(415, 87)
			...
			Me.Name = "ImageElementDemo"
			Me.StartPosition = FormStartPosition.CenterParent
			Me.Text = "Image Element Demo"
