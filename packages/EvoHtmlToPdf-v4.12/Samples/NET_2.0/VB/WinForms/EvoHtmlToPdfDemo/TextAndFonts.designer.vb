Namespace EvoHtmlToPdfDemo
	Partial Public Class TextAndFonts
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(TextAndFonts))
			Me.label1 = New Label()
			...
			Me.btnCreatePdf.Location = New Point(5, 73)
			Me.btnCreatePdf.Name = "btnCreatePdf"
			Me.btnCreatePdf.Size = New Size(75, 28)
...
'			Me.btnCreatePdf.Click += New System.EventHandler(Me.btnCreatePdf_Click)
			...
			Me.btnCancel.Location = New Point(418, 96)
			...
			Me.ClientSize = New Size(427, 113)
			...
			Me.Name = "TextAndFonts"
			Me.StartPosition = FormStartPosition.CenterParent
			Me.Text = "Texts And Font Demo"
