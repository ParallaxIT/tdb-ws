	...
	Partial Public Class TableOfContentsAndBookmarks
		...
		Private Sub btnConvert_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnConvert.Click
			...
			Try
				...
				Dim htmlBookFilePath As String = System.IO.Path.Combine(Application.StartupPath, "..\..\HtmlBook\Book.htm")
				...
				Dim outFilePath As String = System.IO.Path.Combine(Application.StartupPath, "TOCAndBookmarks.pdf")
		...
		Private Sub lnkViewHtmlBook_LinkClicked(ByVal sender As Object, ByVal e As LinkLabelLinkClickedEventArgs) Handles lnkViewHtmlBook.LinkClicked
			' the URL of the HTML document to convert
			Dim htmlBookFilePath As String = System.IO.Path.Combine(Application.StartupPath, "..\..\HtmlBook\Book.htm")
			Try
				Process.Start(htmlBookFilePath)
			Catch
